...
const PUBLIC_FILE = /^\/(?:|[\w-]+\.html|style\.css|(?:site|leagues|leagues-page|team-page|admin)\.js|leagues-data\.json|leagues\/[\w-]+\.json|images\/[\w\/-]+\.(?:jpe?g|png|gif|webp|svg|ico)|forms\/[\w-]+\.pdf)$/;
